...
x402r provides the **authCapture scheme implementation** for x402:
...
sequenceDiagram
    ...
    Operator->>Escrow: capture(paymentInfo, amount)
...
<CardGroup cols={2}>
  <Card title="authCapture Scheme Spec" icon="file-contract" href="/x402-integration/auth-capture-scheme">
    Complete technical specification for the authCapture payment scheme.
  </Card>
