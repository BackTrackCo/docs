---
title: "auth-capture Scheme Specification"
description: "Technical specification for the x402 auth-capture payment scheme"
icon: "file-contract"
---
...
<CardGroup cols={2}>
  <Card title="Overview" icon="globe" href="/x402-integration/overview">
    Understand why HTTP payments need escrow.
  </Card>
