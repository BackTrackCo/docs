...
<Warning>
**CaptureAuthorizer Trust Required:** The captureAuthorizer controls when and how much to capture. Choose carefully and understand the capture policy. See [PaymentOperator](/contracts/payment-operator) for examples.
</Warning>
