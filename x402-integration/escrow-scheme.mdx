...
For detailed explanations of each field, including time field interactions and configuration guidance, see [Payment Fields](/x402-integration/payment-fields).
...
x402r ships a self-hosted facilitator service at `x402r-sdk/examples/facilitator/` that implements x402's facilitator protocol for escrow payments. This service:
