...
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#fafafa','primaryTextColor':'#1f2937','primaryBorderColor':'#9ca3af','secondaryColor':'#f3f4f6','tertiaryColor':'#ffffff','lineColor':'#6b7280','fontFamily':'ui-sans-serif, system-ui, sans-serif'}}}%%
flowchart TD
