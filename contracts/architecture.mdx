...
5. **Designated address** calls `operator.void(paymentInfo)`
...
event OperatorDeployed(address indexed operator, address indexed feeRecipient, address indexed capturePreActionCondition);
