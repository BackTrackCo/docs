...
<Frame>
  <img src="/images/fee-distribution.png" alt="Fee distribution showing payment split between receiver, protocol, and operator" />
</Frame>

**Breakdown:**
- **Payment:** 1000 USDC (100%)
- **Total Fee:** 0.5 USDC (0.05% or 5 basis points)
  - **Protocol Fee:** 0.125 USDC (25% of fee)
  - **Operator Fee:** 0.375 USDC (75% of fee)
- **Receiver Gets:** 999.5 USDC (99.95%)

The FEE_RECIPIENT can be configured as:
