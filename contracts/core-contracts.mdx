...
description: "Detailed explanation of ArbitrationOperator, RefundRequest, and AuthCaptureEscrow"
icon: "file-contract"
---
...
- **Type:** Operator instance (one per arbiter)
- **Deployment:** Via ArbitrationOperatorFactory
...
address public immutable ARBITER;             // Designated arbiter
address public immutable PROTOCOL_FEE_RECIPIENT; // Fee recipient
```
