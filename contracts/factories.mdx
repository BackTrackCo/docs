...
// Deploy operator
const tx = await factory.deployOperator(config);
...
const config = {
  ...
  authorizeRecorder: ethers.constants.AddressZero,
  chargeCondition: providerCondition.address,
  chargeRecorder: ethers.constants.AddressZero,
  releaseCondition: providerCondition.address,
  releaseRecorder: ethers.constants.AddressZero,
  refundInEscrowCondition: ethers.constants.AddressZero,  // No refunds
  refundInEscrowRecorder: ethers.constants.AddressZero,
  refundPostEscrowCondition: ethers.constants.AddressZero,
  refundPostEscrowRecorder: ethers.constants.AddressZero
};

const tx = await factory.deployOperator(config);
console.log("Deployed subscription operator at:", tx);
```
