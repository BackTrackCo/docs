...
timeline
    title Payment Timeline with Freeze
...
%%{init: {'theme':'base', 'themeVariables': { 'fontSize':'16px'}}}%%
timeline
    title Physical Goods Payment Timeline
...
%%{init: {'theme':'base', 'themeVariables': { 'fontSize':'16px'}}}%%
timeline
    title Milestone-Based Payment Timeline
    Day 0 : Client authorizes 1000 USDC for project
    Day 5 : Milestone 1 complete
          : Freelancer calls charge(300 USDC)
          : Receives 300 USDC (minus fees)
    Day 10 : Milestone 2 complete
           : Freelancer calls charge(400 USDC)
           : Receives 400 USDC (minus fees)
    Day 15 : Final milestone
...
%%{init: {'theme':'base', 'themeVariables': { 'fontSize':'16px'}}}%%
timeline
    title Receiver-Initiated Refund Timeline
    Day 0 : Buyer purchases product
...
%%{init: {'theme':'base', 'themeVariables': { 'fontSize':'16px'}}}%%
timeline
    title Subscription Payment Timeline
...
%%{init: {'theme':'base', 'themeVariables': { 'fontSize':'16px'}}}%%
timeline
    title DAO Grant Timeline
    Day 0 : DAO authorizes 50,000 USDC grant
...
%%{init: {'theme':'base', 'themeVariables': { 'fontSize':'16px'}}}%%
timeline
    title Streaming Payment Timeline
    Day 0 : User authorizes 10,000 USDC for 100 days streaming
    Day 10 : Receiver charges for 10 days (1,000 USDC)
    Day 20 : Receiver charges for 10 days (1,000 USDC)
    Day 30 : User cancels stream
           : User calls void()
           : Receives remaining 7,000 USDC back
```
...
%%{init: {'theme':'base', 'themeVariables': { 'fontSize':'16px'}}}%%
timeline
    title B2B Invoice Payment Timeline
    Day 0 : Company A authorizes 100,000 USDC for Invoice #1234
