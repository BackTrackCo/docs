---
title: "Freeze"
description: "Block payment capture when frozen, with configurable freeze/unfreeze authorization"
icon: "snowflake"
---

## Overview

Freeze is a standalone condition that blocks capture when a payment is frozen. It manages freeze/unfreeze state with configurable authorization and optional duration-based auto-expiry.
