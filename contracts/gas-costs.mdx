...
x402r adds escrow, refund windows, and dispute resolution on top of [Base Commerce Payments](https://github.com/coinbase/commerce-payments). Here you'll find the **measured gas cost** of every on-chain operation so you can evaluate the overhead.
