...
| + EscrowPeriod hook | 162,744 | **+26,783** | `EscrowPeriod.run()`: stores `authorizationTime[hash] = block.timestamp` (cold SSTORE to cross-contract slot) |
