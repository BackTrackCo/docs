...
|---------------|-----|---------------|--------|
| PaymentOperator (no plugins, no fees) | 117,250 | — | All conditions, recorders, and fee calculator set to `address(0)` |
...
| Configuration | Gas | Marginal Cost | Plugin |
|---------------|-----|---------------|--------|
| PaymentOperator (no plugins, no fees) | 77,926 | — | All conditions, recorders, and fee calculator set to `address(0)` |
...
| PaymentOperator, no plugins (authorize + release) | 195,176 | 18.9x | < $0.005 |
