...
Most payments never go through a dispute. When they do, off-chain resolution adds < $0.005 — see [Dispute Path](#dispute-path) below.
...
If off-chain resolution fails, every step can be executed on-chain:
...
Total dispute cost on Base fully on-chain: **< $0.05**.
