...
Chain configuration uses numeric chain IDs. Use the CAIP-2 helpers for conversions:

```typescript
import { getChainConfig, fromNetworkId, toNetworkId } from '@x402r/core';

// Correct - numeric chain ID
const config = getChainConfig(84532);

// Convert from EIP-155 string
const chainId = fromNetworkId('eip155:84532'); // 84532
