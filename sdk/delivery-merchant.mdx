...
<CodeGroup>
```bash npm
npm install @x402r/sdk @x402r/core @x402r/helpers
```
```bash pnpm
pnpm add @x402r/sdk @x402r/core @x402r/helpers
```
```bash bun
bun add @x402r/sdk @x402r/core @x402r/helpers
```
</CodeGroup>

`@x402r/core` is needed for `deployDeliveryProtectionOperator()`. `@x402r/helpers` is needed for `forwardToArbiter()`.
