...
- **Arbiters** review disputes and approve or deny refund requests
...
For low-level access to contract ABIs and deploy utilities: `npm install @x402r/core viem`

For x402 server integration: `npm install @x402r/helpers @x402r/evm`

### Quickstarts

<CardGroup cols={2}>
  <Card title="Quickstart for Merchants" icon="store" href="/sdk/merchant-quickstart">
    Deploy an operator, accept a payment, release funds from escrow.
  </Card>
  <Card title="Quickstart for Payers" icon="user" href="/sdk/payer-quickstart">
