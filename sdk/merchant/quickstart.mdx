...
<Info>
**Most merchants start here:** The [merchant-server example](/sdk/examples#merchant-server) shows how to accept escrow payments via HTTP middleware. This SDK (`@x402r/merchant`) is for post-payment lifecycle -- releasing funds, handling refund requests, and managing escrow.
</Info>
