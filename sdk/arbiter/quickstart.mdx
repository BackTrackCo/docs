...
async function main() {
  ...
  try {
    ...
    if (error instanceof Error) {
      console.error('Arbiter operation failed:', error.message);
    }
    throw error;
  }
}
...
<Tip>
Always wrap SDK operations in try-catch blocks. The SDK throws descriptive errors for contract reverts and unauthorized actions.
</Tip>
