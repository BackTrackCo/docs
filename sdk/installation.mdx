...
<Warning>
The X402r SDK packages are not yet published on npm. Install directly from the [GitHub repository](https://github.com/BackTrackCo/x402r-sdk) using your package manager's Git URL support, or clone the repo and link locally.
</Warning>
