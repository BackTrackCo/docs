...
**When to use:** AI content verification (garbage detection), schema validation, or any flow where every response needs automated quality checks before funds are released.
