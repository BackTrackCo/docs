---
title: "Monitoring"
description: "Monitor deposits, refund windows, and payment events in the x402r protocol"
icon: "chart-line"
---
...
<Info>
See [Smart Contracts](/contracts) for details on contract architecture and the events each contract emits.
</Info>
...
<Tip>
The Graph provides efficient GraphQL queries for complex filtering and pagination. Ideal for dashboards and analytics.
</Tip>
...
// Run every 12 seconds (Base block time)
setInterval(() => indexPayments(lastIndexedBlock), 12000);
```
...
<CardGroup cols={2}>
  <Card title="Smart Contracts" icon="cube" href="/contracts">
    Understand contract architecture and configuration patterns.
  </Card>
  <Card title="Contract Deployment" icon="rocket" href="/contract-deployment">
    Deploy and configure x402r contracts for your network.
  </Card>
  <Card title="Security" icon="shield" href="/security">
    Review security best practices and incident response procedures.
  </Card>
</CardGroup>
