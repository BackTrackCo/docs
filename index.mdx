...
<Info>
x402r is in active development. The protocol is deployed on Base Sepolia and Base Mainnet, but the SDK (v0.1.0) is experimental. See the [SDK overview](/sdk/overview) for details.
</Info>
...
| Component | Purpose |
|-----------|---------|
| **PaymentOperator** | Manages payment authorization, release, charge, and refunds |
| **RefundRequest** | Handles refund request lifecycle and approvals |
| **EscrowPeriod** | Tracks escrow timing for time-based release conditions |
